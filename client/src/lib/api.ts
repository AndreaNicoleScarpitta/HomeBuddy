import type { Home, System, MaintenanceTask, MaintenanceLogEntry, InspectionReport, InspectionFinding, ContractorAppointment, NotificationPreferences, HomeDocument } from "@shared/schema";
